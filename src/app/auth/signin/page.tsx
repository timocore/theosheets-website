    ...
    <main className="min-h-screen bg-parchment flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm">
          ...
          <div className="mt-6">
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-parchment text-charcoal-light">or</span>
              </div>
            </div>
            <button
              type="button"
              onClick={() => signIn("google", { callbackUrl: redirectTo })}
              className="w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-border-warm rounded bg-white text-charcoal hover:bg-parchment-dark transition-colors"
            >
        ...
        <p className="mt-6 text-center text-sm text-charcoal-light">
          <Link href="/auth/reset-password" className="underline hover:text-honey">
            Forgot password?
          </Link>
        </p>
        <p className="mt-2 text-center text-sm text-charcoal-light">
          Don&apos;t have an account?{" "}
          <Link href="/auth/signup" className="underline hover:text-honey">
            Sign up
          </Link>
        </p>
      </div>
